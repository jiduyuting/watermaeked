...
'''
Simplified implementation of label-inconsistent backdoor attacks (BadNets and Blended Attack) on CIFAR-10 dataset.
...
def parse_args():
    parser = argparse.ArgumentParser(description='PyTorch CIFAR-10 Backdoor Attack')
